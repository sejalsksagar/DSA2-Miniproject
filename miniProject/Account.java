...
public class Account extends User
{
	...
	void activity(Scanner sc, ArrayList<AccGNode> GHead)
	{
		...
		do
		{
			...
			switch (ch)
			{
				...
				case '1': profile(sc, GHead);
					break;

				case '2':  System.out.print("Enter username to search: ");
				...
				case '5':  System.out.print("Enter username to unfollow: ");
							search = sc.nextLine();
							F = Twitter.searchUsername(search);
							if (F == null) System.out.println("Entered username doesn't exist.");
							else {
	...
	void bfs(ArrayList<AccGNode> GHead)
	{
		...
		while(!Q.isEmpty()) {
			v = Q.poll();
			if(v.equals(nullv)) System.out.print("\n");
			else {
				v = v.A.gHead;
